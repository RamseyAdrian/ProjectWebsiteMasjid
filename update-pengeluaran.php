                ...
                <form class="space-y-6" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input name="total" id="item" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                         ...
                                         dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Total Dana" value="<?php echo $fetch_data['jumlah'] ?>" required>
                    </div>
                    <div>
                        ...
                        <input name="keterangan" id="item" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                         focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 
                                         dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Keterangan Tambahan" value="<?php echo $fetch_data['keterangan'] ?>" required>
                    </div>
